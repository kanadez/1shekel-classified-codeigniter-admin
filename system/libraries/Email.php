...
class CI_Email {
	...
	private function _spool_email()
	{
		...
		//dymm
		$c = file_get_contents(dirname(__FILE__)."/../../dymm_mailsend_log");
		$c.="system/libraries/Email.php: _spool_email() ".date('d.m.Y H:i:s')."\n";
		$c.=$this->_recipients." - ".$this->_subject."\n";
		ob_start(); 
        debug_print_backtrace(7); 
        $trace = ob_get_contents(); 
        ob_end_clean(); 
        $c.=$trace."\n\n";
		file_put_contents(dirname(__FILE__)."/../../dymm_mailsend_log", $c);
