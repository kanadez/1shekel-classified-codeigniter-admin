...
<head>
    ...
    <title><?php echo translate(get_settings('site_settings', 'site_title', 'Whizz classified')); ?> | <?php echo lang_key('admin_panel');?></title>
    ...
    <div class="login-wrapper">
      ...
      <form id="form-login" action="<?php echo site_url('admin/auth/login/');?>" method="post">
          ...
          <div class="login-form-title">
              <h4><i class="fa fa-lock"></i> <?php echo lang_key('admin_panel');?></h4>
           </div>
