        ...
        <li class="<?php echo is_active_menu('admin/classified/'); ?>">
            ...
            <ul class="submenu">
                ...
                <li class="<?php echo is_active_menu('post-ad'); ?>">
                    <a href="http://1shekel.com/new.php">
                ...
                <li class="<?php echo is_active_menu('admin/classified/csvloader'); ?>">
                    <a href="<?php echo site_url('admin/classified/csvloader'); ?>">
                        <?php echo lang_key('csvloader'); ?>
                    </a>
                </li>
                <li class="<?php echo is_active_menu('admin/classified/minuswords'); ?>">
                    <a href="<?php echo site_url('admin/classified/minuswords'); ?>">
                        <?php echo lang_key('minuswords'); ?>
                    </a>
                </li>
                <!--<li class="<?php echo is_active_menu('admin/classified/checkout2settings'); ?>">
                    <a href="<?php echo site_url('admin/classified/checkout2settings'); ?>">
                        Настройки 2CheckOut
                    </a>
                </li>
