        ...
        <div class="box">
            ...
            <div class="box-content">
                ...
                <h3><?php echo lang_key('post_price_settings');?></h3>
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 col-lg-2 control-label">Включить 2CheckOut</label>

                        <div class="col-sm-9 col-lg-3 controls">
                            <select name="enable_2checkout_transfer" class="form-control" id="enable_2checkout_transfer">
                                <?php $options = array('Yes'=>'Yes','No'=>'No');?>
                                <?php $v = (set_value('enable_2checkout_transfer')!='')?set_value('enable_2checkout_transfer'):$settings->enable_2checkout_transfer;?>
                                <?php foreach($options as $key=>$row){?>
                                    <?php $sel=($v==$key)?'selected="selected"':'';?>
                                    <option value="<?php echo $key;?>" <?php echo $sel;?>><?php echo $row;?></option>
                                <?php }?>
                            </select>
                            <input type="hidden" name="enable_2checkout_transfer_rules" value="required">
                            <span class="help-inline">&nbsp;</span>
                            <?php echo form_error('enable_2checkout_transfer'); ?>
                        </div>
                    </div>
