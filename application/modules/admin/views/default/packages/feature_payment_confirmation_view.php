    ...
    <div class="contact-us-three">
        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12">
                ...
                <div class="label label-success"><?php echo lang_key('package_title');?> : <?php echo lang_key($package->title);?></div><div class="clearfix" style="margin-top:5px;"></div>
                ...
                <?php if(get_settings('package_settings','enable_2checkout_transfer','Yes')=='Yes'){?>

                    <?php

                    $action = (get_settings('2checkout_settings','enable_sandbox_mode','No')=='Yes')?'https://sandbox.2checkout.com/checkout/purchase':'https://www.2checkout.com/checkout/purchase';

                    ?>

                    <form action="<?php echo $action;?>" method="post" target="_top">
					
					  <input type='hidden' name='sid' value='103058566' />
					  <input type='hidden' name='mode' value='2CO' />
					  <input type='hidden' name='merchant_order_id' value='<?php echo $unique_id; ?>' />
					  <input type='hidden' name='li_0_type' value='product' />
					  <input type='hidden' name='li_0_name' value='<?php echo get_settings('paypal_settings','item_name','Package');?>' />
					  <input type='hidden' name='li_0_price' value='<?php echo $package->price;?>' />

                    <button type="submit" class="btn btn-primary">Go to 2CheckOut</button>
