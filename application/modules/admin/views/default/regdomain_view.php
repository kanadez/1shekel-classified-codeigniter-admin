...
<body>
  <?php //include 'template/theme_settings.php';?>
    <div class="container" id="main-container">
        <div class="domreg">
          <h4>Подтвердите лицензию</h4>
          <p>Для подтверждения нажмите кнопку "Продолжить".</p>
          <div class="row" style="text-align:center">
              ...
              <form action="<?php echo site_url('admin/purchase/addkey');?>" method="POST" class="form-horaizontal">
				...
				<label>Номер копии: </label>
                <input type="text" name="item_id" value="NULLED-TEAMECHO" plcaholder="" class="form-control input-md-3">   
                <label>Код покупателя: </label>
                <input type="text" name="purchase_key" value="NULLED-TEAMECHO" plcaholder="" class="form-control input-md-3"> 
                <input type="hidden" name="form_key" value="<?php echo $this->session->userdata('form_key');?>"/>        
                <input type="submit" value="Продолжить" class="btn btn-success" style="margin-top:10px;">
              </form>
              </div>
              <div class="col-md-4" stye="margin:0 auto;"></div>
          </div>  
