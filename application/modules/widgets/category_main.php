...
<div class="block-heading-two">
   <h1><i class="fa fa-folder"></i> <?php echo lang_key('site-title'); ?></h1>
</div>
    ...
    <div class="col-md-4 col-sm-6 col-xs-12">
        ...
        <div class="icon-box-1-item category-item">
            ...
            <ul>
                ...
                <li>
                    <a class="" title="Просмотр объявлений в категории <?php echo lang_key($child->title);?>" href="<?php echo site_url('show/categoryposts/'.$child->id.'/'.dbc_url_title(lang_key($child->title)));?>">
