...
<div class="s-widget">
    <!-- Heading -->
    <div class="title-widget"><i class="fa fa-diamond color"></i>  <?php echo lang_key('featured_posts');?></div>
    <!-- Widgets Content -->
            ...
            <ul class="list-unstyled">
                ...
                foreach ($query->result() as $post) {
                    ...
                    <li class="col-xs-12 col-sm-6 col-md-12 col-lg-12">
                        ...
                        <!-- Price -->
                        <div class="price"><strong><?php echo lang_key('price');?></strong>: <?php echo show_price($post->price,$post->contact_for_price);?></br>
