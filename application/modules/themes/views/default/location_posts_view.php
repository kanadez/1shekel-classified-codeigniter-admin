...
<div class="page-heading-two">
    <div class="container">
        ...
        <h1><?php $arr = array(
// Города
'/index.php/ru/location-posts/556/city/%D0%98%D0%B5%D1%80%D1%83%D1%81%D0%B0%D0%BB%D0%B8%D0%BC' => 'Бесплатные частные объявления Иерусалима', 
);
echo isset($arr[$_SERVER['REQUEST_URI']]) ? $arr[$_SERVER['REQUEST_URI']] : get_location_name_by_id($location_id);?></h1>
