...
<!-- Page heading two starts -->
    <div class="page-heading-two">
        <div class="container">
			...
			<h1><?php echo get_user_fullname_by_id($user->id); ?> </h1>
                    ...
                    <div class="row">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    ...
                                    <p class="contact-types">
                                        ...
                                        <strong><?php echo lang_key('email');?>:</strong> <a href="mailto:<?php echo $user->user_email; ?>" rel="nofollow"><?php echo $user->user_email; ?></a>
                                        <?php }?>
                                    </p>
