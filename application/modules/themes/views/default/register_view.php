        ...
        <div class="col-md-7">
            ...
            <div class="well login-reg-form" >
                ...
                <form style="max-width: 615px" class="form-horizontal" role="form" action="<?php echo site_url('account/register/');?>" method="post">
                    ...
                    <div class="form-group">
                        <label for="password" class="col-sm-3 control-label"><?php echo (isset($question))?$question:'';?></label>
                        <div class="col-sm-9">
                            <input type="text" name="ans" value="" class="form-control" style="width:100px">
                        ...
                        <div class="col-sm-offset-3 col-sm-9">
                            ...
                            <div class="checkbox">
                                <label>
                                    ...
                                    <?php echo lang_key('ive_read_the'); ?> <a target="_blank" href="<?php echo site_url('show/page/rules');?>"><?php echo lang_key('rules'); ?></a>
                                </label>
