...
//dymm added cities 
?>
<div class="city_select_new pull-right">
<label for="input-112"><?php echo lang_key('select_city');?></label>
<select id="input-112" name="city" class="form-control chosen-select">
...
<form action="<?php echo site_url('show/advfilter')?>" method="post" id="city_select_new_form">
...
$(document).ready(function(){
	$('.city_select_new select').change(function(){
		$('#city_select_new_form input[name=city]').val( $(this).val());
		$('#city_select_new_form').submit();
