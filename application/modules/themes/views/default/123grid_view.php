...
<!--            <img class="" alt="" src="--><?php //echo theme_url();?><!--/assets/img/featured_img.png">-->
            <div class="img-box-4-content" <?php if($post->featured == 1){ ?>style="background-color: #fff7c5;"<?php } ?>>
                <?php if($post->featured == 1){ ?>
                    <span class="hot-tag" data-toggle="tooltip" data-placement="left" data-original-title="<?php echo lang_key('featured');?>"><i class="fa fa-diamond"></i></span>
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 info-dta"><?php echo translateable_date($post->create_time); ?></div>
                </div>
