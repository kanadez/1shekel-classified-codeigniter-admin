...
<div class="page-heading-two">
    <div class="container">
            <div class="breads">
            <a href="<?php echo site_url(); ?>"><?php echo lang_key('home'); ?></a> / Новости
        </div>
        <h1><?php echo get_blog_data_by_lang($blogpost,'title'); ?> </h1>
                ...
                <?php
                    ...
                    <div class="blog-two-item">
                        ...
                        <div class="blog-two-content">
                            ...
                            <div class="blog-meta">
                                <!-- Date -->
                                <i class="fa fa-calendar"></i> &nbsp; <?php echo translateable_date($blogpost->create_time); ?> &nbsp;
                                <!-- Author -->
                    ...
                    <div class="blog-author well">
                        ...
                        <div class="blog-author-content">
                            <div class="title-widget"><?php echo get_user_fullname_by_id($blogpost->created_by); ?></div>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                <!-- Comments section -->
                    <div class="blog-comments">
                        ...
                        <?php if($comment_settings == 'Disqus Comment'){ ?>
                            <?php $disqus_shortname = get_settings('classified_settings', 'disqus_shortname', 'dbcinfotech'); ?>
