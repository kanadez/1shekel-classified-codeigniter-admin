	...
	<h6 id="myModalLabel">Менеджер медиафайлов</h6>
	</div>
	<div class="modal-body">
		<ul class="nav nav-tabs" id="myTab">
	    	<li class="active"><a href="#upload" data-toggle="tab">Загрузить</a></li>
	    ...
	    <div class="tab-conten" id="myTabConten" style="min-height:300px;">
            <div id="upload" class="tab-pane fade in active">
				...
				<button class="btn primary useimg" style="display:none;">Использовать это</button>
				</div>				
            </div>
...
<!--	<button class="btn btn-primary">Save changes</button>-->
    ...
    jQuery('.useimg').click(function(){
    	...
    	jQuery('#'+target+'_preview').html('<img src="<?php echo base_url('assets/images/thumb')?>/'+img+'" alt="Идет загрузка...."//>');
